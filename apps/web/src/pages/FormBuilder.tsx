...
import { CalendarDays, CheckSquare2, ChevronDown, ChevronUp, Database, Fingerprint, GripVertical, Image, Layers3, Loader2, Plus, Type } from "lucide-react";
...
const fieldTypeLabel = (t: (key: TranslationKey) => string, type: FormFieldType) => t(({ text: "forms.text", date: "forms.date", "multiple choice": "forms.multipleChoice", photo: "forms.photo" } as const)[type]);
