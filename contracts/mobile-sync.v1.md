...
Les pièces jointes des soumissions sont des références `minioPath` ; le mobile ne transmet pas les octets dans ce contrat. Un dossier confirmé est supprimé de la file locale. Un dossier rejeté est conservé et son compteur de tentatives augmente afin de permettre une reprise explicitement visible à l’agent.
